...
class HardLimits @Inject constructor(
    ...
    val VERY_HARD_LIMIT_MAX_BG = intArrayOf(85, 270)
    ...
    val MINDIA = doubleArrayOf(2.0, 2.0, 2.0, 2.0, 2.0)
    ...
    val MINISF = 2.0 // mgdl
    val MAXISF = 1620.0 // mgdl
    val MAXIOB_AMA = doubleArrayOf(3.0, 5.0, 7.0, 12.0, 25.0)
    val MAXIOB_SMB = doubleArrayOf(3.0, 7.0, 12.0, 80.0, 40.0)
